...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__recommendations_recommendations_component__ = __webpack_require__("../../../../../src/app/recommendations/recommendations.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__tweet_tweet_component__ = __webpack_require__("../../../../../src/app/tweet/tweet.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_10__recommendations_recommendations_component__["a" /* RecommendationsComponent */],
            __WEBPACK_IMPORTED_MODULE_11__tweet_tweet_component__["a" /* TweetComponent */]
        ],
        imports: [
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_5__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_4__services_data_service__["a" /* DataService */], __WEBPACK_IMPORTED_MODULE_6__services_auth_guard_service__["a" /* AuthGuardService */]],
...
module.exports = "<h1>{{ title }}</h1>\n<div *ngIf=\"loggedIn\" class=\"col-md-6\">\n  <h1><img src=\"{{ user.photoUrl }}\" alt=\"\">{{ user.name }} <span>{{ user.username }}</span></h1>\n</div>\n\n<hr>\n<ul class=\"nav nav-pills\" *ngIf=\"loggedIn\">\n  <li routerLinkActive><a [routerLink]=\"['recommendations']\">Recommendations</a></li>\n  <li><a href=\"/auth/logout\" (click)=\"onLogOut()\">LogOut</a></li>\n</ul>\n"
...
module.exports = "<h1>This is the recommendation component served by Angular</h1>\n<pre>{{ tweets | json }}</pre>\n<!-- <app-tweet-card *ngFor=\"let tweet of tweets\" [tweet]=\"tweet\"></app-tweet-card> -->\n"
...
var RecommendationsComponent = (function () {
    ...
    RecommendationsComponent.prototype.ngOnInit = function () {
        ...
        function (tweets) { return _this.tweets = tweets; });
    };
...
module.exports = "<div class=\"card\">\n  <img class=\"card-img-top\" src=\"{{ tweet.entities.media[0].media_url }}\" alt=\"Card image cap\" *ngIf=\"tweet.entities.media\">\n  <div class=\"card-block\">\n      <h4 class=\"card-title\">{{ tweet.user.screen_name }}</h4>\n      <p class=\"card-text\">{{ tweet.text }}</p>\n  </div>\n</div>\n"
