...
module.exports = "<h1>Yelp Recommendations for </h1>\n<app-tweet *ngFor=\"let tweet of tweets.businesses\" [tweet]=\"tweet\"></app-tweet>\n"
...
var RecommendationsComponent = (function () {
    ...
    RecommendationsComponent.prototype.ngOnInit = function () {
        ...
        // Add 'implements OnInit' to the class.
        var _this = this;
        this.dataService.getTweets().subscribe(function (tweets) { return _this.tweets = tweets; });
    };
...
module.exports = "<div class=\"card\">\n  <img class=\"card-img-top\" src=\"{{ tweet.image_url }}\" alt=\"Card image cap\" *ngIf=\"tweet.name\">\n  <div class=\"card-block\">\n      <h4 class=\"card-title\">{{ tweet.name }}</h4>\n      <p class=\"card-text\">{{ tweet.text }}</p>\n  </div>\n</div>\n"
